...
export default function Login() {
  ...
  return (
    <section className="relative mx-auto flex min-h-[100dvh] max-w-7xl flex-col justify-center gap-8 px-4 sm:px-6 lg:grid lg:grid-cols-12 lg:items-start lg:gap-12 lg:py-16">
